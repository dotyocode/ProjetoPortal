...
@Component({
  selector: 'app-select-curso',
  templateUrl: './select-curso.component.html',
  styleUrls: ['./select-curso.component.css']
})
export class SelectCursoComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<SelectCursoComponent>,
  ...
  selectedCurso(event: any) {
    ...
    if (this.cursoSelected !== null) {
      ...
      this.router.navigate([`/painel-admin/${event.id}/editarCurso`])
